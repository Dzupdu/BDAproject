...
data_world <- list(x =years,x2 =years^2,x3 =years^3, y = world_num, N = length(years), xpred = 2030)
sm_cubic_single <- rstan::stan_model(model_code = code_cubic_single)
world_cubic_model <- rstan::sampling(sm_cubic_single, data = data_world, iter = 20000, control = list(max_treedepth = 20))
